...
const navByRole: Record<Role, NavItem[]> = {
  requester: [
    ...
    { to: "/app/in-progress",    label: "در حال انجام",              icon: Activity },
    { to: "/app/completed",      label: "تکمیل‌شده‌ها",              icon: CheckCircle2 },
    { to: "/app/wallet",         label: "کیف پول",                   icon: Wallet },
    { to: "/app/reviews",        label: "نظرات و امتیازها",          icon: Star },
    { to: "/app/chat",           label: "گفت‌وگوها",                 icon: MessagesSquare },
  ...
  agent: [
    ...
    { to: "/app/applications",   label: "درخواست‌های من",            icon: FileText },
    { to: "/app/accepted",       label: "پذیرفته‌شده‌ها",            icon: Briefcase },
    { to: "/app/completed",      label: "تکمیل‌شده‌ها",              icon: CheckCircle2 },
  ...
  admin: [
    ...
    { to: "/app/admin/finance",  label: "مالی و تراکنش‌ها",          icon: Wallet },
