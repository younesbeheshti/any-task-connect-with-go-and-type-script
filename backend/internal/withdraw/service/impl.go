...
func NewWithdrawService(repo repository.Repository, publisher common.Publisher) *WithdrawService {
	return &WithdrawService{repo: repo, publisher: publisher}
}
